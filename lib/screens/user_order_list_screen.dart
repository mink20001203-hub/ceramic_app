...
class UserOrderListScreen extends StatelessWidget {
  ...
  Widget _statusPill(String status) {
    final bool isCancel = status.contains('취소');
    final Color bg = isCancel ? const Color(0xFFF6DDDA) : OudColors.surface;
    final Color fg = isCancel ? const Color(0xFF9D4A3E) : OudColors.text;
    return Container(
